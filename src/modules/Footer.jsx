    ...
    <footer className="footer">
        <div className="container footer_container">
            <a className="footer__logo-link">
                <img src="image/logo.svg" alt="Логотип Cup time" className="footer_logo" />
            </a>
            ...
            <div className="footer__info">
                ...
                <p className="footer_description">Проект сделан в учебных целях</p>
                <ul className="footer__developers">
                    ...
                    <li className="footer__developer">
                        Developer: 
                        <a href="#" className="footer__developer-link">Anastasia Kunaeva</a>
                    </li>
                </ul>
            </div>
