    ...
    <section className="order">
        <div className="container">
            ...
            <form className="order__form">
                ...
                <input className="order__input order__input_adress" type="text" name="address" placeholder="Адрес" />
                <fieldset className="order__payment">
                    <h3 className="order__payment-title">Оплата:</h3>

                    <label className="order__payment-label">
                        <input className="oreder__radio" type="radio" name="payment" value="card" />
                        Картой
                    </label>
                    <label className="order__payment-label">
                        <input className="oreder__radio" type="radio" name="payment" value="cash" defaultChecked />
                        Наличные
                    </label>
                </fieldset>
            </form>
